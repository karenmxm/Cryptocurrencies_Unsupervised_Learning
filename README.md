...
We removed non-trading cryptocurrencies in the cryptocurrencies data and predict four clusters using PCA to reduce dimention and unsupervised learning K-means algorithm from sklearn. 
